const clientId = '618ada3c1a644485b4cf2eb3ff472a39'
  ...
  export async function getAccessToken(
    ...
    async function fetchProfile(token: string): Promise<any> {
      ...
      function query(selector: string) {
        ...
        query('#imgUrl').innerHTML = `<img src="${profile.images[0]?.url ?? '(https://www.hojeemdia.com.br/image/policy:1.376750.1628473040:1628473040/image.jpg?w=1280&)'}" alt="Imagem de perfil">`;
      }